# Try out the game turtle graphics game “Hit the target” and examine the code.
# Modify the program so hints are provided to the user when the target is missed.
# For example: “Try a greater angle” or “Use less Force”
...
if (turtle.xcor() >= TARGET_LLEFT_X and
    ...
    turtle.ycor() <= (TARGET_LLEFT_Y + TARGET_WIDTH)):
        ...
        # add functionality to give hints to the player